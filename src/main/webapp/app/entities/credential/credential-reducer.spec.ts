...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDENTIAL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CREDENTIALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CREDENTIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREDENTIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREDENTIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREDENTIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREDENTIAL actions', async () => {
      const expectedActions = [
        {

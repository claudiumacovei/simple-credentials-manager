  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="simplecredentialsmanagerApp.identityProvider.home.createOrEditLabel" data-cy="IdentityProviderCreateUpdateHeading">
            <Translate contentKey="simplecredentialsmanagerApp.identityProvider.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('simplecredentialsmanagerApp.identityProvider.name')}

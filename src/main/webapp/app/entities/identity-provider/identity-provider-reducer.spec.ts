...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './identity-provider.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDENTITYPROVIDER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_IDENTITYPROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_IDENTITYPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IDENTITYPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IDENTITYPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IDENTITYPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IDENTITYPROVIDER actions', async () => {
      const expectedActions = [
        {

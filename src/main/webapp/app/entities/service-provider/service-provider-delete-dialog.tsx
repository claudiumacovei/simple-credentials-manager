...
export const ServiceProviderDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simplecredentialsmanagerApp.serviceProvider.delete.question">
        <Translate contentKey="simplecredentialsmanagerApp.serviceProvider.delete.question" interpolate={{ id: serviceProviderEntity.id }}>

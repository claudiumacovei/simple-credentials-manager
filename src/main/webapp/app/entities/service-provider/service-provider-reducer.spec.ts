...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEPROVIDER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SERVICEPROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SERVICEPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICEPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICEPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEPROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICEPROVIDER actions', async () => {
      const expectedActions = [
        {
